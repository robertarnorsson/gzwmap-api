...
const LittleBirdDown_Objective1_LRI: objective = {
  ...
  image: {
    large: "/assets/objectives/little-bird-down.webp",
    small: "/assets/objectives/thumbnail/little-bird-down.webp"
  },
...
const LittleBirdDown_Objective2_LRI: objective = {
  ...
  faction: LamangRecoveryInitiative,
  image: {
    large: "/assets/objectives/little-bird-down-crew.webp",
    small: "/assets/objectives/thumbnail/little-bird-down-crew.webp"
  },
  types: [MarkerType.TASK, MarkerType.LOCATE, MarkerType.HANDSHAKE, MarkerType.PHALANG],
  location: PhaLang
}
